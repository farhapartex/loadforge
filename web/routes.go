...
func (s *Server) registerRoutes() {
	...
	s.mux.Handle("/settings", s.requireAuth(http.HandlerFunc(s.handleSettings)))
	s.mux.Handle("/api/settings/password", s.requireAuth(http.HandlerFunc(s.handleChangePassword)))
